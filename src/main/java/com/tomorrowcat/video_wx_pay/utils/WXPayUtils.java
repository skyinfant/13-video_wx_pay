...
public class WXPayUtils {
    ...
    public static String createSign(SortedMap<String, String> params, String key) {
        ...
        //生成stringA   eg："appid=wxd930ea5d5a258f4f&body=test&device_info=1000&mch_id=10000100&nonce_str=ibuaiVcKdpRxkhJA";
        while (it.hasNext()) {
            Map.Entry<String, String> entry = it.next();
            String k = entry.getKey();
            String v = entry.getValue();
            //sign和key这个2个参数不参与生成sign
            if (null != v && !"".equals(v) && !"sign".equals(k) && !"key".equals(k)) {
                sb.append(k + "=" + v + "&");
            }
        }
        //生成stringSignTemp   stringA+"key=xxx"
     ...
     * 校验签名
     *
     * 用户扫码确认支付后，微信那边将会回调我方接口，携带的参数里包含sign，我方拿其余参数生成sign，然后与
     * 携带的sign比较，如果一致则校验成功，继续后续操作
     *
     * @param params
     * @param key
     * @return
